...
: ${AMENT_CURRENT_PREFIX:="/home/user/YDS_ws/install/velodyne_distance"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/velodyne_distance/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/velodyne_distance/environment/path.sh"
